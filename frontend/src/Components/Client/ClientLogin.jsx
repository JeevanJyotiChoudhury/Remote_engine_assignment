...
const ClientLogin = () => {
  ...
  const handleLogin = async () => {
    try {
      ...
      const response = await axios.post("https://odd-rose-crocodile-toga.cyclic.app/clients/login", {
        email,
        password,
      });
  ...
  return (
    <Box w="40%" m="auto" mt={4}>
      ...
      <Text mt={2}>
        Do not have an account? <Link color="blue" onClick={()=>navigate("/clientsignup")}>Signup here</Link>
      </Text>
