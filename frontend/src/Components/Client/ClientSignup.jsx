...
const ClientSignup = () => {
  ...
  const handleSignup = async () => {
    try {
      ...
      const response = await axios.post("https://odd-rose-crocodile-toga.cyclic.app/clients/register", {
        name,
        email,
        password,
      });
  ...
  return (
    <Box w="40%" m="auto" mt={4}>
      ...
      <Text mt={2}>
        Already signed up? <Link color="blue" onClick={() => navigate("/clientlogin")}>Login here</Link>
      </Text>
